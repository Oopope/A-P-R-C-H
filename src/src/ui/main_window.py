...
class AqualiDashboard(QMainWindow):
    ...
    def init_ui(self):
        ...
        for contenedor in self.gestor.contenedores:
            ...
            pbar = QProgressBar()
            pbar.setMaximum(contenedor.capacidad_maxima)
            pbar.setValue(contenedor.litros_actuales)
        ...
        for actividad, litros in self.gestor.ACTIVIDADES.items():
            ...
            # Usamos una función lambda con argumento por defecto para capturar el valor correcto en el bucle
    ...
    def registrar_actividad(self, actividad):
        ...
        if litros_gastados > 0:
            # En un entorno real, guardaríamos esto en el historial diario. 
